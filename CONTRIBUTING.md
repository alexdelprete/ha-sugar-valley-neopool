# Contributing to Sugar Valley NeoPool
...
pytest tests/ --cov=custom_components/sugar_valley_neopool --cov-report=term-missing
```
...
ty check custom_components/sugar_valley_neopool
```
